...
void setup(){
    ...
    {
        xTaskCreate(taskMaqEstados,"taskMaqEstados", 150, NULL, 1, &xTaskMaqEstados);
        xTaskCreate(taskObterEvento,"taskObterEvento", 150, NULL, 1, &xTaskObterEvento);
//        xTaskCreate(taskLerSensores,"taskLerSensores", 150, NULL, 3, &xTaskLerSensores);
//        xTaskCreate(taskEscreveLCD,"taskEscreveLCD", 150, NULL, 4, &xTaskEscreveLCD);
//        xTaskCreate(taskEscreveSD,"taskEscreveSD", 100, NULL, 3, &xTaskEscreveSD);
//        //xTaskCreate(taskBluetooth,"taskBluetooth", 100, NULL, 3, &xTaskBluetooth);
//        vTaskStartScheduler();
    }
    else
    {
