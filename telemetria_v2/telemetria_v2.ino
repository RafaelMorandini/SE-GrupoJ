...
void setup(){
    ...
    //bluetooth.setp();
    iniciaSistema();
    Serial.println("Setup concluído -> Estado: IDLE");
    ...
    if(xQueue != NULL && xBinarySemaphore != NULL)
    {
        ...
        xTaskCreate(taskEscreveLCD,"taskEscreveLCD", 300, NULL, 1, &xTaskEscreveLCD);
        xTaskCreate(taskEscreveSD,"taskEscreveSD", 300, NULL, 1, &xTaskEscreveSD);
